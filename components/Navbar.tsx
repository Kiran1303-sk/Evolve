...
export default function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-[#C8A96B]/25 bg-[#0F0F0F] backdrop-blur-2xl shadow-[0_18px_44px_rgba(0,0,0,0.22)]">
      <nav className="section-wrap flex h-20 items-center justify-between sm:h-[4.75rem] md:h-[4.75rem]">
        <Link
          href="#home"
          className="logo-image-wrap relative h-14 w-[11.25rem] sm:h-14 sm:w-56 md:h-14 md:w-56"
        ...
        >
          ...
          <Image
            ...
            alt=""
            fill
            sizes="(max-width: 640px) 11.25rem, 14rem"
            quality={80}
