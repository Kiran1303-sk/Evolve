    ...
    <>
      ...
      <main className="orbit-theme">
        ...
        <section id="highlights" className="neo-showcase py-20 md:py-24">
          <div className="section-wrap">
            <p className="kicker text-[#3d6f4b]">PROJECT JOURNEY</p>
            <h2 className="mt-3 font-display text-4xl text-[#183025] md:text-6xl">Plans, Maps, and Future Vision</h2>
                ...
                <ScrollReveal key={item.src}>
                  <article className="journey-strip grid gap-6 md:grid-cols-2 md:gap-10">
                    ...
                    <div className="self-center">
                      ...
                      <h3 className="mt-2 font-display text-3xl leading-tight text-[#193429] md:text-5xl">{item.title}</h3>
                      <p className="mt-4 text-[#345a45]">{item.blurb}</p>
                      <ul className="mt-5 space-y-2 text-[#345a45]">
        ...
        <section id="features" className="neo-band py-20 md:py-24">
          <div className="section-wrap">
            <p className="kicker text-[#3d6f4b]">INFRASTRUCTURE</p>
            <h2 className="mt-3 font-display text-4xl text-[#183025] md:text-6xl">Core Capability Deck</h2>
            <div className="mt-10 grid gap-5 md:grid-cols-2">
              {infrastructure.map(({ title, icon: Icon, desc, stat }) => (
                <article key={title} className="infra-card">
                  ...
                  <p className="mt-3 text-[#345a45]">{desc}</p>
        ...
        <section id="master-plan" className="neo-contact py-20 md:py-24">
          <div className="section-wrap grid gap-8 md:grid-cols-[1fr_1fr] md:items-center">
            <div>
              <p className="kicker text-[#3d6f4b]">MASTER PLAN</p>
              <h2 className="mt-3 font-display text-4xl text-[#183025] md:text-6xl">{masterPlan.title}</h2>
              <p className="mt-4 text-[#345a45]">{masterPlan.blurb}</p>
              <ul className="mt-5 space-y-2 text-[#345a45]">
        ...
        <section id="connectivity" className="neo-band py-20 md:py-24">
          <div className="section-wrap grid gap-8 md:grid-cols-[1fr_1fr] md:items-center">
            <div>
              <p className="kicker text-[#3d6f4b]">CONNECTIVITY MAP</p>
              <h2 className="mt-3 font-display text-4xl text-[#183025] md:text-6xl">{connectivity.title}</h2>
              <p className="mt-4 text-[#345a45]">{connectivity.blurb}</p>
              <ul className="mt-5 space-y-2 text-[#345a45]">
        ...
        <section id="contact" className="neo-contact py-20 md:py-24">
          <div className="section-wrap grid gap-8 md:grid-cols-[1fr_1fr] md:items-center">
            <div>
              <p className="kicker text-[#3d6f4b]">CONTACT & QR</p>
              <h2 className="mt-3 font-display text-4xl text-[#183025] md:text-6xl">Plan Your EVOLVE Visit</h2>
              <p className="mt-4 text-[#345a45]">{contact.blurb}</p>
